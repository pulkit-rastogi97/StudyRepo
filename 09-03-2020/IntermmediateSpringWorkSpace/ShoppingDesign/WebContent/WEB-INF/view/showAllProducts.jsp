    ...
    <div>
        <h1>Product Details....</h1><br>
            <c:forEach items="${products}" var="entry">
                ${entry.key},&nbsp&nbsp Product_Name = ${entry.value.productName},&nbsp&nbsp Product_Price = ${entry.value.productPrice}&nbsp&nbsp&nbsp&nbsp <a href="addToCart?id=${entry.key}">Add To Cart</a><br><br>
            </c:forEach>
